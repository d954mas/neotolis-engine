...
Собрать ресурсный слой движка: стабильные `AssetMeta`, pack registry, NEOPAK parsing и неблокирующий async loading, встроенный в frame loop.
...
- NEOPAK header/entry parsing и zero-copy asset access.
...
3. [Task 3.3 — NEOPAK Parser and Zero-Copy Asset Access](./task03_neopak_parser_and_zero_copy_asset_access.md)
