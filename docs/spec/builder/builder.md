...
The fixed stats storage holds `NT_BUILD_MAX_ATLASES` records (1024 by default, matching the default asset ceiling), so observability does not impose a lower atlas limit.
