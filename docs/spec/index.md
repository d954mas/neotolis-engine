...
| *(`engine/anim_bank`, `engine/anim_gpu` — contract headers only; `engine/skin_comp`, skinned renderer in `engine/renderers` — planned, epic #472)* | [anim/skeletal-animation.md](anim/skeletal-animation.md) |
