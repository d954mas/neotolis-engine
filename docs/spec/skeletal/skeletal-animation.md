...
The [skeletal showcase](../../../examples/skeletal_showcase/README.md) composes
these modules into imported skinned characters, procedural body/clothes with
distinct inverse binds, and order-dependent instancing. Its paused CPU reference
reads copied exported MESH data and draws beside GPU skinning.
