...
reads copied exported MESH data and draws beside GPU skinning. Native and WebGL2
captures verify unlit deformation and batching; lighting normals and the full
context-loss/retry gate remain outside that evidence.
