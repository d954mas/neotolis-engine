...
#define ATLAS_BENCH_TRANSFORMS_EXPORT ((uint8_t)(ATLAS_BENCH_TRANSFORMS_IDENTITY | (1U << NT_ATLAS_XFORM_ROT90)))
...
/* Parse a transform mask: a hex byte (0x00..0xFF) or a case-insensitive preset
 * word (all|identity|export|rotations|flips). Returns false on any other input. */
