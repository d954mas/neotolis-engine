...
#define ASSET_ATLAS_REGION_UI_BUTTONS_DEMO_ATLAS_BUTTON_RED ((nt_hash64_t){0x72F1164809108B78ULL}) /* ui_buttons_demo_atlas/button_red */
...
static inline void ui_buttons_demo_assets_register_labels(void) {
    ...
    (void)nt_hash64_str("ui_buttons_demo_atlas/button_red");
