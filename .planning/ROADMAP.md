...
- [x] **Phase 31: Material & Shape Fixes** - Runtime material param updates and uint32 shape indices (completed 2026-03-22)
...
**Depends on**: Phase 30
**Requirements**: MAT-01, MAT-03, SHAPE-01, SHAPE-02 (MAT-02 superseded by D-05)
**Success Criteria** (what must be TRUE):
  ...
  2. `nt_material_set_param` writes all 4 components and `nt_material_set_param_component` writes a single component (per D-13)
...
Plans:
- [x] 31-01-PLAN.md -- Material param mutation API (set_param, set_param_component, has_param) + mesh renderer vec4 uniform fix
- [x] 31-02-PLAN.md -- Shape renderer compile-time uint16/uint32 index selection based on MAX_VERTICES
...
| 31. Material & Shape Fixes | v1.4 | 2/2 | Complete   | 2026-03-22 |
