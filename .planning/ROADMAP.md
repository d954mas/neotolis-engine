...
- v1.2 Runtime Renderer (in progress) - Phases 12-18
...
- [ ] **Phase 18: Desktop GL Rendering** - Vendor glad, GLFW native window, GL backend on desktop
...
- [ ] 16-02-PLAN.md -- Complex shapes: circle/cube/sphere tessellation (fill + wireframe + rotation variants), cylinder/capsule shapes, mesh draw, remaining unit tests
...
**Goal:** Vendor glad, integrate GLFW for native window with real GL context, enable nt_gfx GL backend on desktop. Includes glad loader in ctx_native, glClearDepth variant, and native window with real GL context instead of 800x600 stub.
**Requirements**: TBD
**Depends on:** Phase 15
