...
- [x] **MAT-01**: Material is a runtime object: shader handle + texture handles[] + vec4 params[] + render state
- [x] **MAT-02**: Game creates materials in code from loaded shader and textures
- [x] **MAT-03**: Material render state includes blend mode, depth test/write, cull mode
- [x] **MAT-04**: All numeric material params stored as vec4[] (per spec section 16.2)
...
| MAT-01 | Phase 26 | Complete |
| MAT-02 | Phase 26 | Complete |
