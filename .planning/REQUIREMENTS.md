...
- [x] **WINISO-01**: GLFW usage confined to nt_window_native.c and nt_gfx_gl_ctx_native.c only -- no GLFW in nt_app or nt_input
- [x] **WINISO-02**: nt_window provides swap_buffers, set_vsync, should_close, request_close as public API
- [x] **WINISO-03**: nt_window_poll() calls nt_input_poll() internally -- one call per frame handles both window and input
- [x] **WINISO-04**: Game explicitly calls nt_window_swap_buffers() -- nt_app does not auto-swap after frame_fn
- [x] **WINISO-05**: All new nt_window functions have parity implementations across native, web, and stub backends
...
| DESK-01 | Phase 18 | Complete |
| DESK-02 | Phase 18 | Complete |
| DESK-03 | Phase 18 | Complete |
| DESK-04 | Phase 18 | Complete |
| DESK-05 | Phase 18 | Complete |
| DESK-06 | Phase 18 | Complete |
| WINISO-01 | Phase 19 | Complete |
| WINISO-02 | Phase 19 | Complete |
| WINISO-03 | Phase 19 | Complete |
| WINISO-04 | Phase 19 | Complete |
| WINISO-05 | Phase 19 | Complete |
