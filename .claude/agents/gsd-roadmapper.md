...
Reference full template: `C:/projects/neotolis-engine/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/projects/neotolis-engine/.claude/get-shit-done/templates/state.md`.
