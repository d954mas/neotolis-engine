...
**В работе (шаг 2):** игрок хочет как в Loop Hero — маленький аул (2x2) по центру, зона больше
(~6x6), и дорогу не фиксированным прямоугольником, а **извилистым замкнутым лупом с изгибами,
разным каждый круг/наследника**. Переписываю генератор. Появятся новые config-ключи геометрии
(зона, размер аула, число изгибов) — отдельно отпишу, что отдать тебе в баланс.
