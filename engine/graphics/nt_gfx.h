...
typedef enum {
    ...
    NT_GFX_GL_BINDRENDERBUFFER,
    NT_GFX_GL_BINDSAMPLER,
    NT_GFX_GL_BINDTEXTURE,
    NT_GFX_GL_BINDVERTEXARRAY,
    NT_GFX_GL_BLENDCOLOR,
    NT_GFX_GL_BLENDEQUATIONSEPARATE,
    NT_GFX_GL_BLENDFUNCSEPARATE,
    NT_GFX_GL_BUFFERDATA,
    NT_GFX_GL_BUFFERSUBDATA,
    NT_GFX_GL_CLEAR,
    NT_GFX_GL_CLEARCOLOR,
    NT_GFX_GL_COMPILESHADER,
    NT_GFX_GL_COMPRESSEDTEXIMAGE2D,
    NT_GFX_GL_CREATEPROGRAM,
    NT_GFX_GL_CREATESHADER,
    NT_GFX_GL_CULLFACE,
    ...
    NT_GFX_GL_DELETETEXTURES,
    NT_GFX_GL_DELETEVERTEXARRAYS,
    NT_GFX_GL_DEPTHFUNC,
    NT_GFX_GL_DEPTHMASK,
    NT_GFX_GL_DISABLE,
    NT_GFX_GL_DRAWARRAYS,
    NT_GFX_GL_DRAWARRAYSINSTANCED,
    NT_GFX_GL_DRAWELEMENTS,
    ...
    NT_GFX_GL_SCISSOR,
    NT_GFX_GL_SHADERSOURCE,
    NT_GFX_GL_TEXIMAGE2D,
    NT_GFX_GL_TEXPARAMETERI,
    NT_GFX_GL_TEXSUBIMAGE2D,
    NT_GFX_GL_UNIFORM1F,
    NT_GFX_GL_UNIFORM1I,
    NT_GFX_GL_UNIFORM4FV,
    NT_GFX_GL_UNIFORMBLOCKBINDING,
    NT_GFX_GL_UNIFORMMATRIX4FV,
    NT_GFX_GL_USEPROGRAM,
    NT_GFX_GL_VERTEXATTRIB4F,
    NT_GFX_GL_VERTEXATTRIBDIVISOR,
    NT_GFX_GL_VERTEXATTRIBPOINTER,
    NT_GFX_GL_VIEWPORT,
...
typedef struct {
    ...
    union {
        ...
        struct {
            uint32_t first, count, vertices, instances, vertex_input;
        } draw;
        struct {
            uint32_t name, count;
            float values[16];
