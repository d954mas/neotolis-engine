 ...
 * chevron, close, and do the ONE trigger step_interaction (toggling *open on a click). Mirrors the data-form
 * nt_ui_dropdown_trigger interior, fed a single `preview` string instead of labels[]/selected. */
